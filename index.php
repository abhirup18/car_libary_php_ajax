...
?>
<?php
include('dbconnection_original.php');
?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Luxury Toys - 2nd-hand Car dealer</title>
...
<div class="allcontain">
	<div class="header">
			...
			<ul class="logreg">
				...
				<li><span style="color: rgb(255, 215, 0);"><?=$_SESSION['sess_user'];?></span></li> 
				<li><a href="login/logout.php"><span> &nbsp &nbsp Logout</span></a> </li>
	...
	<nav class="topnavbar navbar-default topnav">
		...
		<div class="collapse navbar-collapse" id="upmenu">
			<ul class="nav navbar-nav" id="navbarontop">
				...
				<li>
					<a href="display/dist/display_index.php">VIEW</a>
				</li>
				<!-- <li>
				...
				?>
				<li>
					<a href="admin/admin_login.php"><span>ADMIN</span></a>
				</li>
				<li class="active">
						<a href="seller/seller_index.php"  role="button" aria-haspopup="true" aria-expanded="false"><span>SELLERS</span></a>
				...
				?>
				<li>
					<a href="buyer/my_order.php"><span>MY ORDER</span></a>
				</li>
				<?php
					}
				?>

				<!-- <button><span class="postnewcar">POST NEW CAR</button> -->
			</ul>
		</div>
	</nav>
</div>
...
<!-- ------------------ Code did not got executed ------------------- -->
<!-- <div class="allcontain">
	<?php
	$ret = mysqli_query("select * from form order by id asc");
		...
		<div class="carousel-inner " role="listbox">
			<div class="item active">
				<?php
					if($row['target']==0){
				?>
				<img src="admin/photos.jpg" alt="oldcar">
				<?php
					}else{
				?>
				<img src="seller/photos_s.jpg" alt="oldcar">
				<?php
					}
				?>
				<div class="carousel-caption">
