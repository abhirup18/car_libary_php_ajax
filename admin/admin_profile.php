...
<head>
  ...
  <title>Car Library - Admin Profile</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section profile">
     ...
     <?php
$ret1=mysqli_query($con,"select * from admin where id =1 ;");
...
?>
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <?php  echo "<img src='photos/profile_image/".$row1['image']."' class='rounded-circle' alt='Profile' >"; ?>
               <?php  if(isset($_SESSION["sess@user"]))
                  {
                ?>
              <h2><?=$_SESSION['sess@user'];?></h2>
              <?php
                }
              ?>
              <h3>Web Designer</h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <h5 class="card-title">Profile Details</h5>
                   <?php
$ret=mysqli_query($con,"select * from admin where id =1 ;");
 ...
 -->
                ...
                <!--   <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['a_email'] ;?></div>
                  </div>
                  ...
                  <form method="POST" action="" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <!-- <a class="btn btn-primary btn-sm" title="Upload new profile image" name="upload"><i class="bi bi-upload"></i></a> -->

                           <input type="file" name="image">
                           <!-- <button type="submit" name="upload" >Submit</button> -->


                          <!-- <a href="#" class="btn btn-danger btn-sm" title="Remove my profile image" name="remove"><i class="bi bi-trash" ></i></a> -->
...
<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $target = "photos/profile_image/".basename($image);
