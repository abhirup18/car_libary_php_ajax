  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link " data-bs-target="#forms-nav"  href="booked_cars.php">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php
$ret=mysqli_query($con,"select * from booking order by id asc;");
$cnt=1;
...
<!--Fetch the Records -->
   ...
   <!-- <a href="read.php?viewid=<?php echo htmlentities ($row['id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            ...
                            <a class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>-->
                              ...
                              <a href="update.php?updateid=<?php echo htmlentities ($row['id']);?>"><input type="submit" class="btn btn-info" value="Update" ></a>
