...
$photo=$_GET['ppic'];
$ppicpath="photos"."/".$photo;
$sql=mysqli_query($con,"delete from form where ID=$rid");
unlink($ppicpath);
...
<head>
  ...
  <title>Car Library - Display</title>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php
$ret=mysqli_query($con,"select * from form order by id asc;");
$cnt=1;
...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?>
                          <img src="photos/<?php  echo $row['photo'];?>" width="80" height="80">
                          <?php
                            }
                            else{
                          ?>
                          <img src="../seller/photos_s/<?php  echo $row['photo'];?>" width="80" height="80">
                          <?php
                            }
                          ?>
                        </td>
   ...
   <!-- <a href="read.php?viewid=<?php echo htmlentities ($row['id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            ...
                            <a class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>-->
                              ...
                              <a href="edit.php?editid=<?php echo htmlentities ($row['ID']);?>"><input type="submit" class="btn btn-info" value="Edit" ></a>
                            

                        </td>
                        <td>
                            <a href="admin_table.php?delid=<?php echo ($row['ID']);?>&&ppic=<?php echo $row['photo'];?>"><input type="submit" class="btn btn-danger" value="Delete"></a>
                        </td>
                    </tr>
                    <?php 
$cnt=$cnt+1;
