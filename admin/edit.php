...
<head>
  ...
  <title>Car Library - Edit Form</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data">
                 <?php
                    $eid=$_GET['editid'];
                    $ret=mysqli_query($con,"select * from form where ID='$eid'");
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="phone" value="<?php  echo $row['phone'];?>" required = "true">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="vehicleno" value="<?php  echo $row['vehicle_no'];?>" required = "true">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name="comments" required = "true">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="fueltype" value="<?php  echo $row['fuel_type'];?>" required = "true">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="type" value="<?php  echo $row['type'];?>" required = "true">
                  </div>
                </div>
              ...
              <!--   <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="submit5">Submit Form</button>
                  </div>
                </div>
...
$query=mysqli_query($con, "insert into form(name,email,model,phone,address,date,vehicle_no,comments,size,fuel_type,type,photo) values('$name','$email','$model',$phone, '$address','$date','$vehicle_no','$comments','$size','$fuel_type','$type','$imgnewfile')");
